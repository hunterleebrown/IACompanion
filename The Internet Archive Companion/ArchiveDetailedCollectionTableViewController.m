//
//  ArchiveDetailedCollectionTableViewController.m
...
@interface ArchiveDetailedCollectionTableViewController ()

@end

@implementation ArchiveDetailedCollectionTableViewController
...
- (void)setCollectionIdentifier:(NSString *)identifier{
    ...
    [dataService getCollectionsWithName:archiveIdentifier];
